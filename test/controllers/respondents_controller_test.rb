...
class RespondentsControllerTest < ActionController::TestCase
  ...
  test "should create respondent" do
    assert_difference('Respondent.count') do
      post :create, respondent: { gender: @respondent.gender, height: @respondent.height, weight: @respondent.weight }
    end
  ...
  test "should update respondent" do
    patch :update, id: @respondent, respondent: { gender: @respondent.gender, height: @respondent.height, weight: @respondent.weight }
    assert_redirected_to respondent_path(assigns(:respondent))
  end
